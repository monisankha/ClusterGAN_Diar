...
# Inputs:
wavList=$PWD/data$1/wavList_boscclinic							# File with list of audio files to be diarized
echo "$wavList"
inputVADDir=$PWD/data$1/vad_boscclinic/kaldiVAD		# Directory with VAD files; labels@frame-level every line
echo "$inputVADDir"
# Other params
kaldiDir=/home/moni/kaldi/
voxcelebDir=$kaldiDir/egs/voxceleb/v2/
callhomeDir=$kaldiDir/egs/callhome_diarization/v2/
dataDir=$currDir/data$1/tmpkaldidir_boscclinic
workDir=$currDir/data$1/tmpkaldidir_boscclinic_cmn
...
python3 $currDir/vad_boscclinic.py --pathname $currDir --data $1
